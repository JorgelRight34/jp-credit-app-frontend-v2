import { createLinkDataCell, DataTableConfig } from "@/components";
...
export const projectsDataTableConfigColumns: DataTableConfig<Project>["columns"] = [
    ...
    { accessorKey: "name", header: "NOMBRE", cell: ({ row }) => createLinkDataCell(row.original.name, {}), enableSorting: true },
