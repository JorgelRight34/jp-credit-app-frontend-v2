import { buildDateDataCell, buildExpandableDescriptionCell, buildLinkDataCell, BuildSearchInputDataTableConfigHandler, buildSingleSelectCell, DataTableConfig } from "@/components";
...
export const buildTransactionSearchInputTable: BuildSearchInputDataTableConfigHandler<Transaction> = (setValue) => ({
